...
object Dependencies {
  ...
  private def akkaHttpModule(module: String)               = "com.typesafe.akka"             %% module            % "10.2.4"
  private def nettyModule(module: String)                  = "io.netty"                      % s"netty-$module"   % "4.1.63.Final"
  private def kamonModule(module: String)                  = "io.kamon"                      %% s"kamon-$module"  % "2.1.15"
  ...
  private def catsModule(module: String, version: String = "2.1.1") = Def.setting("org.typelevel" %%% s"cats-$module"  % version)
  ...
  val shapeless  = Def.setting("com.chuusai" %%% "shapeless" % "2.3.4")

  val scalaTest = "org.scalatest" %% "scalatest" % "3.2.7" % Test

  val sttp3 = "com.softwaremill.sttp.client3" % "core_2.13" % "3.2.3"
  ...
  val lang = Def.setting(
    Seq(
      ...
      ("org.parboiled" %%% "parboiled" % "2.2.1").exclude("org.scala-js", "scalajs-library_2.13"),
